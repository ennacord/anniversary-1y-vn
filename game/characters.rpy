init python:
    ...
    def character_factory(name, kind=None, callback=None, *args, **kwargs):
        ...
        nvl_character = Character(name, kind=nvl, callback=nvl_callback, what_color="#999999", *args, **kwargs)
...
# Mana: Fixed it, added "i" and "inn"
define millie_character = character_factory(_("Millie"), color="#FEBC87", image="millie")
define mi = millie_character[0]
define minn = millie_character[1]

define millie_character_special = character_factory(_("\"Millie\""), color="#FEBC87", image="millie")
define ms = millie_character[0]
define msn = millie_character[1]

define enna_millie_character = character_factory(_("Enna, Millie"), color="#858ED1", image="enna")
define enmi = enna_character[0]
define enmin = enna_character[1]
...
define enna_reimu_character = character_factory(_("Enna, Reimu"), color="#858ED1", image="enna")
define enre = enna_character[0]
define enren = enna_character[1]
...
define reimu_nina_character = character_factory(_("Reimu, Nina"), color="#B90B4A", image="reimu")
define reni = reimu_character[0]
define renin = reimu_character[1]
